                        ...
                        <div className='flex items-center gap-2 opacity-70'>
                            {
                                role === "user" ? (
                                    ...
                                    <>
                                        <Image className='w-4.5 cursor-pointer' alt="" src={assets.copy_icon} />
                                        <Image className='w-4.5 cursor-pointer' alt="" src={assets.regenerate_icon} />
                                        <Image className='w-4.5 cursor-pointer' alt="" src={assets.like_icon} />
                                        <Image className='w-4.5 cursor-pointer' alt="" src={assets.dislike_icon} />
                                    </>
                                )
                            }
                        </div>
